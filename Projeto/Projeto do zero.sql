...
INSERT INTO Funcionário (idFuncionário, PrimeiroNomeFuncionário,  NomeDoMeioFuncionário,  SobrenomeFuncionário,  CPFdoFuncionário)
           VALUES(001, 'CLAUDIA', 'S', 'LIMA', 111),
			     (002, 'PAULO', 'R', 'SOUZA', 222),
                 (003, 'CARLOS', 'O', 'SOLLA', 333);
...
-- Recuperar todos os clientes do Sobrenome  "Carvalho"

SELECT*FROM Funcionário
WHERE SobrenomeFuncionário = 'Carvalho';

SELECT*FROM Empresa;

-- Recuperar todos os fornecedores do Sobrenome "Santos"
